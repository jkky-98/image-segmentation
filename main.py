...
def main():
    ...
    val_loader = DataLoader(val_dataset, batch_size=16, num_workers=2, pin_memory=True, drop_last=True, shuffle=False)
    ...
    for i in range(EPOCHS):
        ...
        if max_score < valid_logs['iou_score']:
            ...
            torch.save(model, './best_model_DLV3+_se_resnet101_2_256.pth')
            print('Model saved!')
